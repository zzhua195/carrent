...
<div class="layui-layout layui-layout-admin">
        ...
        <div class="layui-main mag0">
            ...
            <ul class="layui-nav top_menu">
                ...
                <li class="layui-nav-item" id="userInfo">
                    <a href="javascript:;"><img src="${ctx}/resources/images/face.jpg" class="layui-nav-img userAvatar" width="35" height="35"><cite class="adminName">${user.loginname}</cite></a>
    ...
    <div class="layui-footer footer">
        <p><span>copyright @2018 i不许嵩手</span></p>
    </div>
</div>
...
<script>
    ...
    layui.use(['bodyTab','form','element','layer','jquery'],function(){
        ...
        tab = layui.bodyTab({
            ...
            url : "${ctx}/menu/loadLeftIndexMenu.action" //获取菜单json地址
        });
